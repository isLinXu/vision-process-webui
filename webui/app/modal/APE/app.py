...
os.system("pip install lvis")
os.system("pip install fairscale")
os.system("pip install git+https://github.com/facebookresearch/detectron2@017abbf")
os.system("pip install git+https://github.com/IDEA-Research/detrex@776058e")
os.system("pip install git+https://github.com/openai/CLIP.git@d50d76d")
os.system("pip install git+git+https://github.com/shenyunhang/ape")
