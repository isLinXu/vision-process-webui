...
examples = [["../images/sa_8776.jpg"], ["../images/sa_414.jpg"], ["../images/sa_1309.jpg"], ["../images/sa_11025.jpg"],
            ["../images/sa_561.jpg"], ["../images/sa_192.jpg"], ["../images/sa_10039.jpg"], ["../images/sa_862.jpg"]]
...
cond_img_t = gr.Image(label="Input with text", value="../images/dogs.jpg", type='pil')
    ...
    with gr.Tab("Text mode"):
        ...
        with gr.Row():
            with gr.Column():
                ...
                gr.Markdown("Try some of the examples below ⬇️")
                gr.Examples(examples=[["../images/dogs.jpg"]] + examples,
                            inputs=[cond_img_e],
                            # outputs=segm_img_e,
                            # fn=segment_everything,
                            # cache_examples=True,
